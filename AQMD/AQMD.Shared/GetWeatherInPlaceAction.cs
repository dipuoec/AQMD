...
{ 
    ...
    {
        public  Task<object> FulfillAsync(string Place , string AppKey )
        {
            var result = GetCard(Place , AppKey);
            return Task.FromResult((object)result);
        }
        public Task<object> FulfillAsyncAlexa(string Place, string AppKey)
        {
            var result = GetAlexaCard(Place, AppKey);
            return Task.FromResult((object)result);
        }

        private static AlexaCardContent GetAlexaCard(string place , string AppKey)
        {
        ...
        private static AdaptiveCard GetCard(string place, string AppKey)
        {
